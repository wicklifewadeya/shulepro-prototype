...
CREATE TABLE `company_details` (
    ...
    UNIQUE INDEX `company_details_uuid_key`(`uuid`),
    UNIQUE INDEX `company_details_email_key`(`email`),
    INDEX `company_details_name_idx`(`name`),
    INDEX `company_details_city_idx`(`city`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
